...
namespace CD2_Bot
{
    public static class Quests
    {
        ...
        public static List<Quest> questList = new List<Quest>
        {
            ...
            new CraftItemsQuest("Creator of Destruction", "CRW3", "Craft three weapons.", 3, 0, 1700, 300, 50, 0, 0, null, null, 7080, "Now that you have mastered the art of forging there is many that want to learn from you. Show them how its done!", "Impeccable .", "I am gravely dissapointed in you.", "You have crafted %current%/%goal% weapons.", 15, QuestActivations.CraftItemAny, "weapon"),
            //craft armor quests
            ...
            new TrainQuest("Metal Man", "TNA1", "Train with your armor a few times.", 7, 3, 500, 50, 0, 10, 0, null, null, 2160, "You do not move well in your armor. Go and train with it.", "Do you see what I meant? It's that easy!", "No improvements have been made here.", "You have trained with your armor %current%/%goal% times.", 0, QuestActivations.TrainCompleteAny, "armor"),
            new TrainQuest("Artifact Abuser", "TNE1", "Train with your extra a few times.", 7, 3, 500, 50, 0, 0, 50, null, null, 2160, "You are not using your extra its full potential. Go tain with it.", "Do you see what I meant? It's that easy!", "No improvements have been made here.", "You have trained with your extra %current%/%goal% times.", 0, QuestActivations.TrainCompleteAny, "extra"),

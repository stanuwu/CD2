...
namespace CD2_Bot
{
    ...
    public class EnemyDrops
    {
        ...
        public static List<Enemy> Enemies = new List<Enemy>
        {
            ...
            new Enemy("Green Ogre", "A giant monster armed with an even larger club. Protective of its territory.", 75, 0, 80, 5, 20, null, null, null),
            new Enemy("Bandit", "A human whose path led them to a life of crime.", 65, 0, 100, 10, 25, null, null, null),
            new Enemy("Bandit Leader", "The leader of a small group of bandits. Some are indepent, some are lieutenants of a larger bandit group.", 75, 0, 100, 11, 30, null, null, null),
            new Enemy("Wandering Tree", "A tree whose roots started to become legs to hunt the fiends who destroyed their habitat.", 80, 0, 100, 10, 20, null, null, new EnemyDrops("Wood", 3, 1, 30)),
            ...
            new Enemy("Scarred Grizzly", "A big bear who lost its cubs to a hunting party. The scars show the battle which soon followed after.", 85, 0, 100, 15, 40, null, null, new EnemyDrops("Bear Pelt", 1, 0, 5)),
            ...
            new Enemy("Black Dragon", "A dragon who has been ousted by its family when it was young. It survived, only motiviated by its anger.", 150, 0, 70, 20, 40, null, null, new EnemyDrops("Dragon Scale", 3, 1, 10)),
            ...
            new Enemy("Magma Golem", "Only found in mountain ranges including volcanoes, this golem seems to be a rare fusion of a stone and a fire golem.", 130, 0, 70, 30, 50, null, null, new EnemyDrops("Stone", 4, 2, 5)),

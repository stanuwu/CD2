...
namespace CD2_Bot
{
    ...
    public class EnemyDrops
    {
        ...
        public static List<Enemy> Enemies = new List<Enemy>
        {
            ...
            new Enemy("Blorb", "Bloated, fallen off flesh from another monster, which somehow formed a life of its own. Sometimes it even grows limbs, wobbling around and being a disgusting sight to behold.", 40, 0, 100, 0, 7, null, null, null),
            ...
            new Enemy("Black Alpha Wolf", "The leader of a pack of black wolves. Often has scars around it eyes gained in battle over the leadership.", 80, 0, 100, 10, 30, null, null, new EnemyDrops("Medium Wolf Pelt", 1, 0, 10)),

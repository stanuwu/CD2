    ...
    public class EnemyDrops
    {
        ...
        public static class EnemyGen
        {
            ...
            public static List<Enemy> Enemies = new List<Enemy>
            {
                ...
                new Enemy("Steely Mimic", "A chest made of steel corrupted by evil, engaging everyone who tries to open it", 70, 0, 90, 5, 17, "Moderate Money Drop", "The player gets a moderate amount of money", new EnemyDrops("Steel", 1, 0, 20), Biome.Any),
                ...
                new Enemy("Black Dragon", "A dragon who has been ousted by its family when it was young. It survived, only motiviated by its anger.", 150, 0, 70, 20, 40, "Moderate Burn", "Causes moderate extra damage depending on the strength of the player and decreases their accuracy.", new EnemyDrops("Dragon Scale", 3, 1, 10), Biome.Mountains),

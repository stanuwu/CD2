    ...
    public class EnemyDrops
    {
        ...
        public static class EnemyGen
        {
            ...
            public static List<Enemy> Enemies = new List<Enemy>
            {
                ...
                new Enemy("Goblin Bandit", "Hostile goblin wielding a melee weapon.", 50, 0, 100, 5, 15, "Small Money Drop", "The player gets a small amount of money", null),
                ...
                new Enemy("White-Eyed Scorpion", "A scorpion who is rougly the size of a pig. Lives in caves because the sunlight hurts its eyes.", 40, 0, 85, 5, 18, "Paralysis", "Decreases the resistance of the player.", null),
                ...
                new Enemy("Bandit", "A human whose path led them to a life of crime.", 65, 0, 100, 10, 25, "Small Money Drop", "The player gets a small amount of money", new EnemyDrops("Small Pouch", 1, 0, 10)),
                new Enemy("Bandit Leader", "The leader of a small group of bandits. Some are indepent, some are lieutenants of a larger bandit group.", 75, 0, 100, 11, 30, "Moderate Money Drop", "The player gets a moderate amount of money", new EnemyDrops("Small Pouch", 1, 0, 15)),
                ...
                new Enemy("Conjoined Blorbs", "Two blorbs who conjoined completely by accident", 80, 0, 100, 15, 21, "Disgusting Appearance", "Increases the damage the player deals", null),
                ...
                new Enemy("Goblin Bandit Squad", "A squad of weak goblin bandits, but they come in numbers.", 80, 0, 90, 15, 37, "Small Money Drop", "The player gets a small amount of money", null),
                new Enemy("Goblin Bandit Squad Leader", "A dwarfish orc posing as a goblin, serving as a leader of a bandit squad.", 85, 0, 95, 16, 33, "Small Money Drop", "The player gets a small amount of money", null),
                new Enemy("Orc Bandit", "Hostile orc wielding a melee weapon, though they only use their fists sometimes.", 90, 0, 90, 20, 35, "Small Money Drop", "The player gets a small amount of money", null),
                ...
                new Enemy("Golden Mimic", "A chest made of gold corrupted by evil, engaging everyone who tries to open it", 100, 0, 80, 30, 50, "Massive Money Drop", "The player gets a massive amount of money", new EnemyDrops("Gold", 1, 0, 20)),
